...
class OpenEduCatLms(CustomerPortal):
    ...
    @http.route('/get/material', type='json', auth="public", website=True)
    ...
    @http.route(['/certificates/<int:order_id>',
                ...
                type='http', auth="user", website=True)
    def portal_order_pages(self, order_id, report_type=None, access_token=None,
                           download=False, **kw):
        try:
    ...
    def get_certificate_overview(
        ...
        searchbar_sortings = {
            'index': {'lebel': _('Index'), 'order': 'index'},
